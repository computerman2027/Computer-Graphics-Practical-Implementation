...
void boundaryFillN8(HDC hdc, int x, int y, COLORREF bordercolor, COLORREF fillColor)
{
    ...
    else
    {
        ...
        boundaryFillN8(hdc, x, y + 1, bordercolor, fillColor);
        boundaryFillN8(hdc, x - 1, y + 1, bordercolor, fillColor);
        boundaryFillN8(hdc, x + 1, y + 1, bordercolor, fillColor);
        boundaryFillN8(hdc, x, y - 1, bordercolor, fillColor);
        boundaryFillN8(hdc, x - 1, y - 1, bordercolor, fillColor);
        boundaryFillN8(hdc, x + 1, y - 1, bordercolor, fillColor);
        boundaryFillN8(hdc, x + 1, y, bordercolor, fillColor);
        boundaryFillN8(hdc, x - 1, y, bordercolor, fillColor);
    }
}
...
void DrawScene(HWND hwnd)
{
    ...
    boundaryFillN8(memDC, xc, yc, RGB(bordercolorRed, bordercolorGreen, bordercolorBlue), RGB(fillcolorRed, fillcolorGreen, fillcolorBlue));
