...
int xc, yc, radius, oldcolorRed, oldcolorGreen, oldcolorBlue, bordercolorRed, bordercolorGreen, bordercolorBlue, fillcolorRed, fillcolorGreen, fillcolorBlue;
...
void floodFillN4(HDC hdc, int x, int y, COLORREF oldcolor, COLORREF fillColor)
{
    ...
    if (currentColor == oldcolor)
    {
        ...
        floodFillN4(hdc, x, y + 1, oldcolor, fillColor);
        floodFillN4(hdc, x, y - 1, oldcolor, fillColor);
        floodFillN4(hdc, x + 1, y, oldcolor, fillColor);
        floodFillN4(hdc, x - 1, y, oldcolor, fillColor);
    }
}
...
void DrawScene(HWND hwnd)
{
    ...
    floodFillN4(memDC, xc, yc, RGB(255, 255, 255), RGB(oldcolorRed, oldcolorGreen, oldcolorBlue));
    
    BitBlt(hdc, 0, 0, width, height, memDC, 0, 0, SRCCOPY); 

    printf("Completed filling 1\n");

    Sleep(5000);
    
    
    floodFillN4(memDC, xc, yc, RGB(oldcolorRed, oldcolorGreen, oldcolorBlue), RGB(fillcolorRed, fillcolorGreen, fillcolorBlue));

    printf("Completed filling 2\n");
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
    ...
    printf("Enter Old Color in RGB format (R G B): ");
    scanf("%d %d %d", &oldcolorRed, &oldcolorGreen, &oldcolorBlue);
    ...
    HWND hwnd = CreateWindowEx(
        0,
        CLASS_NAME,
        "Midpoint Circle with Flood Fill 2",
        WS_OVERLAPPEDWINDOW,
